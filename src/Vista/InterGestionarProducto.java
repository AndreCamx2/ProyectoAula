...
public class InterGestionarProducto extends javax.swing.JInternalFrame {
   ...
   private void CargarComboCategoria() {
    ...
    try {
        ctrl.cargarDesdeJson(Path.of("src/Datos/categorias.json"));
        jComboBox_categoria.removeAllItems();
        jComboBox_categoria.addItem("Seleccione categoria:");
        for (Categoria c : ctrl.listarTodos()) {
            jComboBox_categoria.addItem(c.getDescripcion());
        }
    } catch (IOException e) {
...
/////////////////////////////////////////////////////////////////////
   ...
   private void CargarTablaProductos() {
    ...
    try {
        controlador.cargarDesdeJson(Path.of("src/Datos/productos.json"));
        for (Producto p : controlador.listarTodos()) {
            double ivaCalculado = calcularIva(p.getPrecio(), p.getPorcentajeIva());
    ...
    jTable_productos.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (fila > -1) {
                idProducto = (int) jTable_productos.getValueAt(fila, 0);
    ...
    try {
        controlador.cargarDesdeJson(Path.of("src/Datos/productos.json"));
        Optional<Producto> opt = controlador.listarTodos().stream()
   ...
   private String relacionarCategoria(int idCategoria) {
    ...
    try {
        ctrl.cargarDesdeJson(Path.of("src/Datos/categorias.json"));
        return ctrl.listarTodos().stream()
  ...
  private int IdCategoria() {
    ...
    try {
        ctrl.cargarDesdeJson(Path.of("src/Datos/categorias.json"));
        String desc = jComboBox_categoria.getSelectedItem().toString();
        return ctrl.listarTodos().stream()
            .filter(c -> c.getDescripcion().equalsIgnoreCase(desc))
            .map(Categoria::getId)
            .findFirst()
            .orElse(-1);
    } catch (IOException e) {
