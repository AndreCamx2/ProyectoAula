...
public class FrmMenu extends javax.swing.JFrame {
    ...
    InterCliente cliente = new InterCliente();
    FrmMenu.escritorio.add(cliente);
    ...
    FrmGestionarUsuario ventana = new FrmGestionarUsuario();
        FrmMenu.escritorio.add(ventana);

ventana.setSize(500, 400); // O el tamaño que prefieras
...
try {
    ...
    FrmAgregarUsuario ventana = new FrmAgregarUsuario();
    FrmMenu.escritorio.add(ventana);
